...
SELECT
	...
	SAFE_CAST(Appl_Code  AS  STRING)  AS  Appl_Code,
...
SELECT
	...
	Stmt_Type_Code,
	{{  full_valid_flag(['__NoFutureDate_valid_Acct_Party_Start_Dte','__HKID_valid_Doc_Nbr','__DocTypeCode_valid_Doc_Type_Code','__CountryCode_valid_Issue_Country_Code','__NoFutureDate_valid_Acct_Party_End_Dte'])  }}
FROM  CTE_3)
