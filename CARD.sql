...
SELECT 
    ...
    CAST(Upgrade_Ind AS STRING) AS Upgrade_Ind
FROM CTE_1
),
...
Lang_Code,
Upgrade_Ind,
    {{ aggregate_validation_columns(['__NoFutureDate_Card_Issue_Dte','__Future_Date_Expiry_Dte','__NoFutureDate_Cancl_Dte','__01YN_Chip_Card_Ind','__Future_Date_Eff_Dte','__NoFutureDate_First_Issue_Dte','__01YN_Upgrade_Ind']) }}
FROM CTE_3
)
