...
Processing_Offr_Id,
Seller_Id,
    {{ aggregate_validation_columns(['__NoFutureDate_valid_Acct_Close_Dte','__NoFutureDate_valid_Acct_Open_Dte','__NoFutureDate_valid_Acct_Status_Chng_Dte','__NoFutureDate_valid_Cur_Prod_Start_Dte','__NoFutureDate_valid_Last_Stmt_Dte','__NoFutureDate_valid_Last_Trx_Dte','__NoFutureDate_valid_Start_Dte','__01YN_valid_Id_Doc_Present_Ind']) }}
FROM CTE_3
)
